...
# LP-018: Yield-Bearing Bridge Tokens
...
5. **Redeemability guarantee**: Users can always burn yLETH/yLBTC/yLUSD/yLSOL and receive underlying + accrued yield. The exit guarantee from LP-016 applies: burns are never paused.
