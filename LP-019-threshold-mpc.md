...
The 0.14ms resharing time enables live signer rotation without bridge downtime. The OmnichainRouter's 7-day timelock (LP-016) is a governance delay, not a cryptographic limitation.
...
When the OmnichainRouter proposes a signer rotation (LP-016, 7-day timelock):
