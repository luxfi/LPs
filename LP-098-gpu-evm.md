...
| Resource | Location |
|----------|----------|
| cevm source | `github.com/luxfi/chains/evm/cevm/` |
| Metal shaders | `github.com/luxfi/chains/evm/cevm/gpu/metal/` |
| CUDA kernels | `github.com/luxfi/chains/evm/cevm/gpu/cuda/` |
| Block-STM | LP-010 |
