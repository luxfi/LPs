...
## Per-Algorithm LPs (Index)

LP-137 is the umbrella spec. Every algorithm in the 29-algo stack has a dedicated LP linking its Go canonical, C++ CPU body, and Metal/CUDA/WGSL kernels.

| Family | Algorithm | LP | Status |
|---|---|---|---|
| Hash | SHA-256 | [LP-148](./LP-148-sha256.md) | Final |
| Hash | Keccak-256 | [LP-149](./LP-149-keccak.md) | Final |
| Hash | RIPEMD-160 | [LP-150](./LP-150-ripemd160.md) | Final |
| Hash | BLAKE2b | [LP-151](./LP-151-blake2b.md) | Final |
| Hash | BLAKE3 | [LP-126](./LP-126-blake3.md) | Final |
| Hash | Poseidon2 | [LP-069](./LP-069-poseidon2.md) | Final |
| AEAD | AES-256-GCM | [LP-116](./LP-116-aes-gcm.md) | Final |
| AEAD | ChaCha20-Poly1305 | [LP-117](./LP-117-chacha20.md) | Final |
| Curve | secp256k1 | [LP-147](./LP-147-secp256k1.md) | Final |
| Curve | secp256r1 (P-256) | [LP-123](./LP-123-p256.md) | Final |
| Curve | Ed25519 | [LP-124](./LP-124-ed25519.md) | Final |
| Curve | Curve25519 / X25519 | [LP-112](./LP-112-curve25519.md) / [LP-114](./LP-114-x25519.md) | Final |
| Curve | BN254 (alt_bn128) | [LP-146](./LP-146-bn254.md) | Final |
| Curve | BLS12-381 | [LP-075](./LP-075-bls.md) / [LP-110](./LP-110-bls12-381.md) | Final |
| Curve | Banderwagon | [LP-152](./LP-152-banderwagon.md) | Final |
| Curve | Baby Jubjub | [LP-111](./LP-111-baby-jubjub.md) | Final |
| Curve | Pasta (Pallas/Vesta) | [LP-113](./LP-113-pasta.md) | Final |
| Commitment | KZG (EIP-4844) | [LP-118](./LP-118-kzg.md) | Final |
| Commitment | Pedersen | [LP-119](./LP-119-pedersen.md) | Final |
| Commitment | IPA Bulletproofs | [LP-153](./LP-153-ipa.md) | Final |
| Commitment | Verkle | [LP-026](./LP-026-verkle-trees.md) | Final |
| Lattice | NTT | [LP-029](./LP-029-ntt-transform.md) | Final |
| Lattice | poly_mul | [LP-159](./LP-159-poly_mul.md) | Final |
| PQ Sig | ML-DSA (FIPS 204) | [LP-070](./LP-070-mldsa.md) | Final |
| PQ Sig | SLH-DSA (FIPS 205) | [LP-071](./LP-071-slhdsa.md) | Final |
| PQ Sig | FALCON | [LP-074](./LP-074-falcon.md) | Final |
| PQ Sig | Lamport OTS | [LP-156](./LP-156-lamport.md) | Final |
| PQ KEM | ML-KEM (FIPS 203) | [LP-072](./LP-072-mlkem.md) | Final |
| PQ KEM | X-Wing Hybrid | [LP-115](./LP-115-x-wing.md) | Final |
| Threshold | Ringtail | [LP-073](./LP-073-ringtail.md) | Final |
| Threshold | FROST Schnorr | [LP-154](./LP-154-frost.md) | Draft |
| Threshold | CGGMP21 ECDSA | [LP-155](./LP-155-cggmp21.md) | Draft |
| Threshold | Shamir SSS | [LP-077](./LP-077-shamir.md) | Final |
| Threshold | Universal Framework | [LP-076](./LP-076-threshold.md) | Final |
| FHE | TFHE (F-Chain) | [LP-013](./LP-013-fhe-gpu.md) / [LP-066](./LP-066-tfhe.md) | Final |
| EVM Precompile | evm256 | [LP-157](./LP-157-evm256.md) | Final |
| EVM Precompile | modexp (EIP-198) | [LP-158](./LP-158-modexp.md) | Final |
| Misc | ECVRF | [LP-131](./LP-131-ecvrf.md) | Final |
| Misc | ECIES | [LP-121](./LP-121-ecies.md) | Final |
| Misc | HPKE (RFC 9180) | [LP-122](./LP-122-hpke.md) | Final |
| Attestation | Remote (TEE) | [LP-127](./LP-127-attestation.md) | Final |

Every per-algo LP includes:
- Go canonical path (`lux/crypto/<alg>/`) + Go module + tag
- C++ CPU canonical (`luxcpp/crypto/<alg>/cpp/`) + C-ABI header
- Metal kernel (`luxcpp/crypto/<alg>/gpu/metal/<alg>.metal`)
- CUDA kernel (`luxcpp/crypto/<alg>/gpu/cuda/<alg>.cu`)
- WGSL kernel (`luxcpp/crypto/<alg>/gpu/wgsl/<alg>.wgsl`)
- Test oracle (vendored, test-only — never linked into production)
- KAT vector count + cross-oracle source
...
| lux/threshold | FAIL (ringtail Sign signature drift in test) | 57 ok / 1 fail | YES — #226-class luxfi/log+ringtail Sign API drift | None |
...
| No first-party body authored | ~7 | kzg, ipa (Go A; C++/GPU pending), verkle (Go A; C++/GPU pending), sr25519, frost, cggmp21, ringtail (umbrella) |
...
| Q-Chain | QuantumVM (Ringtail) | luxcpp/lattice + cevm/quasar | v0.43+ | (in cevm) | — | 13 |
...
- **#228 bn254 WGSL Miller** — kernel body landed; CI verification
  pending.
- **#226-class luxfi/log + ringtail Sign API drift** — `lux/threshold`
  `protocols/ringtail` test signature mismatch; one fail in 58.
