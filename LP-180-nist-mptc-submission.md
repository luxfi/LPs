...
4. **No identifiable abort under asynchronous network partition**
   per `docs/known-limitations.md`. Production Lux deployments
   layer Z-Chain Groth16 accountability for this; not a submission
   property per NIST's MPTC criteria.
