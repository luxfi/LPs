...
Validators sign block proposals using BLS12-381 keys registered at stake time (LPS-015). The proposer aggregates signatures into a single 48-byte aggregate:
...
1. **BLS rogue key attack**: mitigated by requiring proof-of-possession at validator registration (LPS-015)
