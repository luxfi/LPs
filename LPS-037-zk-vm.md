...
Cross-chain shielding uses Warp messages (LPS-021): shield on Z-chain, unshield on any Lux chain.

### Compliance Mode

For regulated assets (LPS-001), the Z-chain supports optional compliance disclosure:
