...
The LP token's virtual price is `D / totalSupply`. It monotonically increases as fees accrue. This makes LP tokens suitable as collateral in lending protocols (LPS-044).
