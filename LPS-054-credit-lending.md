...
|---|---|---|---|---|
| Standard | 0 | 86% | 0% | Same as LPS-044 |
...
The borrower's Karma score (LPS-056) determines their tier:
...
Credit loans have the same liquidation mechanics as LPS-044, but with tighter monitoring:
...
- On-chain identity verified via Karma (LPS-056)
...
1. **Karma gaming**: artificial activity to inflate Karma is mitigated by the decay function and activity quality weighting in LPS-056.
...
| Karma integration | LPS-056 |
| Base lending | LPS-044 |
