...
# LPS-086: Governor Contract with Gauge Weights

## Abstract

Defines the Governor contract that executes DAO proposals (LPS-085) and manages gauge-weighted resource allocation. Gauges allow vLUX holders to direct protocol incentives (liquidity mining, ecosystem grants) to specific pools, chains, or programs. Gauge weights are recalculated weekly based on voting.
