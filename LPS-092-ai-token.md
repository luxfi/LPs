...
# LPS-092: Hardware-Attested GPU Mining Token

## Abstract

Defines the AI token (AIT), a mining token earned by contributing verified GPU compute to the Lux AI network. Miners run AI inference and training workloads in TEE-attested environments (LPS-065). Proof-of-Useful-Work attestations are submitted on-chain, and AIT is minted proportionally to verified compute contribution. AIT is redeemable for GPU compute credits or tradeable on the DEX.
