...
# LPS-099: Auditor-Ready Protocol Specification
...
| Consensus: Block-STM parallel execution | LPS-010 | Final |
| Networking: P2P protocol, Warp messaging | LP-6022 | Final |
| Execution: EVM, cevm GPU acceleration | LPS-009, LPS-098 | Final |
| Cryptography: PQ signatures, threshold MPC | LPS-070-078 | Final |
| Privacy: Z-Chain, shielded pools, FHE | LPS-063-068 | Final |
| Identity: DID, IAM, KMS | LPS-060-062 | Final |
| Economics: tokenomics, fees, governance | LPS-080-089 | Final |
| Tokens: WLUX, bridge, staking, AI | LPS-090-094 | Final |
| Infrastructure: safe, AA, multicall | LPS-095-097 | Final |
| Securities: digital securities, compliance | LPS-001-003, LPS-088 | Final |
| Bridge: omnichain router, native programs | LPS-016-018 | Final |
| Validator: key management, rewards | LPS-015, LPS-082-084 | Final |
