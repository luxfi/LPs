...
category: Core
created: 2025-12-11
requires: 7013, 7014, 6015, 6016, 6000, 7103
...
|----|-------|-------------|
| **LP-330** | [T-Chain (ThresholdVM)](/docs/lp-7330-t-chain-thresholdvm-specification/) | Threshold signature chain for distributed key management |
| **LP-331** | [B-Chain (BridgeVM)](/docs/lp-6331-b-chain-bridgevm-specification/) | Bridge coordination chain for cross-chain operations |
| **LP-332** | Teleport Bridge Architecture (this document) | Unified architecture specification |
| **LP-333** | [Dynamic Signer Rotation](/docs/lp-7333-dynamic-signer-rotation-with-lss-protocol/) | LSS protocol for validator set changes |
| **LP-334** | [Per-Asset Key Management](/docs/lp-7334-per-asset-threshold-key-management/) | Independent threshold configs per asset |
| **LP-335** | [Bridge Smart Contracts](/docs/lp-6335-bridge-smart-contract-integration/) | Solidity contract integration |
| **LP-336** | [K-Chain (KeyManagementVM)](/docs/lp-7336-k-chain-keymanagementvm-specification/) | Post-quantum key encapsulation |
...
B-Chain orchestrates bridge operations. See [LP-331](/docs/lp-6331-b-chain-bridgevm-specification/) for complete specification.
...
- Asset registry management (see [LP-334](/docs/lp-7334-per-asset-threshold-key-management/))
...
K-Chain provides post-quantum key management. See [LP-336](/docs/lp-7336-k-chain-keymanagementvm-specification/) for complete specification.
...
See [LP-335](/docs/lp-6335-bridge-smart-contract-integration/) for complete contract specification.
