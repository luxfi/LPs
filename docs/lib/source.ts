...
const LP_TOPICS: CategoryMeta[] = [
  ...
  // ============================================================
  {
    ...
    range: [0, 99],
    tags: ['network', 'architecture', 'topology', 'economics', 'incentives', 'standards'],
    icon: 'globe',
    color: 'blue',
  ...
  // Range: 3000-3499 (LRC-20: 3020-3049, LRC-1155: 3100-3149, LRC-721: 3200-3299, etc.)
  {
    ...
    range: [3000, 3499],
    tags: ['lrc', 'token-standard', 'lrc-20', 'lrc-721', 'lrc-1155', 'lrc-4626', 'lrc-4337', 'lrc-2981', 'lrc-165', 'lrc-173', 'lrc-2612', 'lrc-3156', 'lrc-6909', 'lrc-5192', 'lrc-6551', 'lrc-1271', 'lrc-777', 'vault', 'account-abstraction', 'paymaster', 'flash-loan', 'soulbound', 'royalty', 'permit', 'nft'],
    icon: 'token',
    color: 'amber',
  ...
  // ============================================================
  {
    ...
    range: [3800, 3899],
    tags: ['token', 'tokens', 'tokenomics', 'fungible', 'marketplace', 'teleport', 'bridged-asset'],
    icon: 'coins',
    color: 'yellow',
...
// Sort LPs by numerical order within each category (LP number)
// Priority: 1) Research tag (research goes to end), 2) LP number (numerical order)
// This ensures LPs appear in numerical order regardless of status
function sortLPsWithResearchLast(lps: LPPage[]): void {
  lps.sort((a, b) => {
    // First: Research goes to end within same number
    ...
    // Second: Sort by numerical order (LP number)
