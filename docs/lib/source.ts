...
const LP_CATEGORIES: CategoryMeta[] = [
  ...
  },
  {
    ...
    description: 'Specifications for the C-Chain EVM, precompiled contracts, gas optimization, and smart contract standards. Enables Ethereum-compatible smart contract execution.',
    range: [2000, 2999],
    icon: 'code',
    color: 'cyan',
    learnMore: 'C-Chain runs the Ethereum Virtual Machine with enhanced performance. Precompiles add native functionality for cryptography, cross-chain messaging, and more.',
  ...
  },
  {
    ...
    description: 'Extensions to core protocols including enhanced messaging, state management, and cross-VM communication. Building blocks for advanced blockchain applications.',
    range: [3000, 3999],
    icon: 'extension',
    color: 'teal',
    learnMore: 'Protocol extensions add new capabilities to the base layer. These LPs define how different components of the network communicate and coordinate.',
  ...
  },
  {
    ...
    description: 'Specifications for custom virtual machines, subnet configurations, and specialized execution environments. Enables purpose-built blockchains within Lux Network.',
    range: [4000, 4999],
    icon: 'vm',
    color: 'fuchsia',
    learnMore: 'Custom VMs allow developers to create specialized blockchains. Subnets provide isolated execution environments with custom rules and validators.',
  ...
  },
  {
    ...
    description: 'Standards for cross-chain communication, asset transfers, and multi-chain coordination. Enables seamless interaction between Lux chains and external networks.',
    range: [5000, 5999],
    icon: 'link',
    color: 'sky',
    learnMore: 'Interoperability LPs define how assets and messages flow between chains. Includes ICM (Inter-Chain Messaging), warp messaging, and external bridges.',
  ...
  },
  {
    ...
    description: 'Bridge implementations for connecting Lux to external networks like Ethereum, Bitcoin, and Solana. Secure asset custody and cross-chain verification.',
    range: [6000, 6999],
    icon: 'bridge',
    color: 'lime',
    learnMore: 'Bridge protocols enable trustless asset transfers between Lux and other blockchains. Includes light client verification, relayer networks, and custody solutions.',
  ...
  },
  {
    ...
    description: 'Threshold signature schemes and T-Chain specifications. Multi-party computation for secure key management, distributed signing, and cross-chain custody.',
    range: [7000, 7999],
    icon: 'key',
    color: 'yellow',
    learnMore: 'T-Chain provides threshold cryptography services. Multiple parties cooperatively sign transactions without any single party holding the complete key.',
    keyTopics: ['Threshold signatures', 'MPC protocols', 'Key management', 'Distributed custody'],
  },
  {
    slug: 'advanced',
    name: 'Advanced Protocols',
    shortDesc: 'Advanced specifications',
    description: 'Advanced protocol specifications including zero-knowledge proofs, privacy features, MEV protection, and cutting-edge cryptographic techniques.',
    range: [8000, 8999],
    icon: 'advanced',
    color: 'slate',
    learnMore: 'Advanced LPs push the boundaries of blockchain technology. Includes privacy-preserving computations, MEV mitigation, and experimental features.',
    keyTopics: ['Zero-knowledge', 'Privacy features', 'MEV protection', 'Advanced crypto'],
  },
  {
    slug: 'extended',
    name: 'Extended Specifications',
    shortDesc: 'Extended and experimental',
    description: 'Extended specifications for experimental features, future upgrades, and specialized use cases. Incubator for next-generation Lux Network capabilities.',
    range: [9000, 99999],
    icon: 'flask',
    color: 'neutral',
    learnMore: 'Extended LPs cover experimental and future-facing specifications. These may evolve significantly before reaching final status.',
